...
public class HazeParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, T__40=41, STRING_LITERAL=42, ID=43, INT=44, WS=45, 
		COMMENT=46;
	public static final int
		...
		RULE_structmembervalue = 16, RULE_expr = 17, RULE_args = 18, RULE_functype = 19, 
		RULE_constant = 20, RULE_compilationhint = 21, RULE_compilationhintfilename = 22, 
		RULE_compilationhintflags = 23, RULE_compilationlang = 24, RULE_linkerhint = 25, 
		RULE_structcontent = 26, RULE_structdecl = 27, RULE_datatype = 28;
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'('", "')'", "':'", "'=>'", "'{'", "'}'", "','", "'declare'", 
			"'.'", "';'", "'\"C\"'", "'\"C++\"'", "'let'", "'const'", "'__c__'", 
			"'return'", "'='", "'if'", "'else'", "'while'", "'as'", "'*'", "'/'", 
			"'%'", "'+'", "'-'", "'<'", "'>'", "'<='", "'>='", "'=='", "'!='", "'is'", 
			"'not'", "'and'", "'or'", "'true'", "'false'", "'#compile'", "'#link'", 
			"'struct'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, "STRING_LITERAL", "ID", "INT", "WS", 
			"COMMENT"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 12644383719680L) != 0)) {
				{
				setState(63);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final BodyContext body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 31198643871746L) != 0)) {
				{
				{
				setState(98);
				statement();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 31198642438146L) != 0)) {
					{
					setState(162);
					expr(0);
					}
	...
	public final CompilationhintContext compilationhint() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_compilationhint);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final CompilationhintfilenameContext compilationhintfilename() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_compilationhintfilename);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(322);
	...
	public final CompilationhintflagsContext compilationhintflags() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_compilationhintflags);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(324);
	...
	public final CompilationlangContext compilationlang() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_compilationlang);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final LinkerhintContext linkerhint() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_linkerhint);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(328);
