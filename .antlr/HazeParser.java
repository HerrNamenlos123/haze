...
public class HazeParser extends Parser {
	...
	public static final int
		...
		T__52=53, T__53=54, T__54=55, T__55=56, STRING_LITERAL=57, UNIT_LITERAL=58, 
		NUMBER_LITERAL=59, ID=60, WS=61, COMMENT=62;
	public static final int
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1252000696408998144L) != 0)) {
				{
				setState(68);
				_errHandler.sync(this);
	...
	public final BodyContext body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2168483220712448002L) != 0)) {
				{
				{
				setState(103);
				statement();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case T__15:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2168483220711014402L) != 0)) {
					{
					setState(179);
					expr(0);
					}
