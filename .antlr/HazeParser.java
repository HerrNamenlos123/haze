...
public class HazeParser extends Parser {
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3170534137669645330L) != 0) || _la==ID) {
				{
				setState(82);
				_errHandler.sync(this);
	...
	public final NamespacecontentContext namespacecontent() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3170534137669632018L) != 0) || _la==ID) {
				{
				setState(94);
				_errHandler.sync(this);
	...
	public final NamedfuncContext namedfunc() throws RecognitionException {
		...
		try {
			...
			if (_la==T__3) {
				{
				setState(105);
				((NamedfuncContext)_localctx).export = match(T__3);
				}
			}
	...
	public final BodyContext body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 4)) & ~0x3f) == 0 && ((1L << (_la - 4)) & 4336966441425092611L) != 0)) {
				{
				{
				setState(138);
				statement();
	...
	public final FuncdeclContext funcdecl() throws RecognitionException {
		...
		try {
			...
			if (_la==T__3) {
				{
				setState(177);
				((FuncdeclContext)_localctx).export = match(T__3);
				}
			}
		...
		try {
			...
			case 1:
				...
				if (_la==T__3) {
					{
					setState(215);
					((VariableDefinitionContext)_localctx).export = match(T__3);
					}
				}
			...
			case 2:
				...
				if (_la==T__3) {
					{
					setState(228);
					((VariableDeclarationContext)_localctx).export = match(T__3);
					}
				}
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case T__21:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((((_la - 5)) & ~0x3f) == 0 && ((1L << (_la - 5)) & 2168483220711014401L) != 0)) {
					{
					setState(249);
					expr(0);
					}
	...
	public final StructdeclContext structdecl() throws RecognitionException {
		...
		try {
			...
			if (_la==T__3) {
				{
				setState(444);
				((StructDeclContext)_localctx).export = match(T__3);
				}
			}
