...
/* Print a path as a vscode:// OSC8 hyperlink.
   Displayed text is "filename:line:col", URI is
   vscode://file/<full_path>:line:col full_path  – the complete absolute path
   (may contain backslashes) linecol    – "line:col" suffix string (may be empty
   / zero-length)  */
