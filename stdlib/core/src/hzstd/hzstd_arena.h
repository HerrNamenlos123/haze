...
#define HZSTD_ALLOC_STRUCT_RAW(arena, struct_t, struct_ptr_t, value)                                                   \
  ({                                                                                                                   \
    struct_ptr_t tmp = hzstd_arena_allocate(arena, sizeof(struct_t), alignof(struct_t));                               \
    *tmp = value;                                                                                                      \
    tmp;                                                                                                               \
  })

#define HZSTD_ALLOC_STRUCT(arena, struct_t, struct_ptr_t, value)                                                       \
  HZSTD_ALLOC_STRUCT_RAW((arena)->arenaImpl, struct_t, struct_ptr_t, value)
