            ...
            expectedOutput: (() => {
                ...
                const structType: Semantic.StructDatatypeSymbol = {
                    ...
                    scope: (() => {
                        ...
                        const scope = new Semantic.DeclScope(sourceloc(2, 12), collectedStruct._collect.scope, semanticResult.globalNamespace.scope);
                        return scope;
                    })(),
                };
                ...
                const getMethod: Semantic.FunctionDefinitionSymbol = {
                    ...
                    scope: (() => {
                        ...
                        const scope = new Semantic.BlockScope(sourceloc(3, 16), collectedStruct.methods[0].funcbody._collect.scope)
                ...
                structType.methods.push({
                    ...
                    scope: (() => {
                        const scope = new Semantic.BlockScope(sourceloc(2, 12), new Collect.Scope(sourceloc(2, 12), structType.scope.collectedScope));
                        return scope;
                    })(),
                    methodOf: structType,
                });
                ...
                semanticResult.globalNamespace.scope.symbolTable.defineSymbol({
                    ...
                    scope: (() => {
                        const scope = new Semantic.BlockScope(sourceloc(7, 12), collectedMainFunction.funcbody._collect.scope, semanticResult.globalNamespace.scope);
...
export async function runSemanticTests() {
    const semanticFunction = (globalScope: Collect.Scope) => {
        const result = SemanticallyAnalyze(globalScope);
        return result;
    };
