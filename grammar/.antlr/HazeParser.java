// Generated from /home/fzachs/Projects/haze/grammar/Haze.g4 by ANTLR 4.13.1
...
public class HazeParser extends Parser {
	...
	public static final int
		...
		T__59=60, T__60=61, STRING_LITERAL=62, UNIT_LITERAL=63, NUMBER_LITERAL=64, 
		ID=65, WS=66, COMMENT=67;
	public static final int
		...
		RULE_structcontent = 33, RULE_structdecl = 34, RULE_datatype = 35, RULE_datatypeimpl = 36;
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'=>'", "','", "'inject'", "';'", "'prebuildcmd'", "'postbuildcmd'", 
			"'declare'", "'\"C\"'", "'\"C++\"'", "'let'", "'const'", "'='", "'__c__'", 
			"'return'", "'if'", "'else'", "'while'", "'++'", "'--'", "'+'", "'-'", 
			"'not'", "'!'", "'as'", "'*'", "'/'", "'%'", "'<'", "'>'", "'<='", "'>='", 
			"'=='", "'!='", "'is'", "'and'", "'or'", "'+='", "'-='", "'*='", "'/='", 
			"'%='", "'<<='", "'>>='", "'&='", "'^='", "'|='", "'...'", "'true'", 
			"'false'", "'#compile'", "'link'", "'unsafe_union'", "'struct'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, "STRING_LITERAL", "UNIT_LITERAL", "NUMBER_LITERAL", "ID", 
			"WS", "COMMENT"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3170534137669675042L) != 0) || _la==ID) {
				{
				setState(84);
				_errHandler.sync(this);
	...
	public final NamespacecontentContext namespacecontent() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3170534137669648418L) != 0) || _la==ID) {
				{
				setState(96);
				_errHandler.sync(this);
	...
	public final BodyContext body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 5)) & ~0x3f) == 0 && ((1L << (_la - 5)) & 2168483220712546307L) != 0)) {
				{
				{
				setState(147);
				statement();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case T__21:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((((_la - 6)) & ~0x3f) == 0 && ((1L << (_la - 6)) & 1084241610355507201L) != 0)) {
					{
					setState(258);
					expr(0);
					}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 6:
						...
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 35993612647923712L) != 0)) ) {
	...
	public final DatatypeimplContext datatypeimpl() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_datatypeimpl);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
