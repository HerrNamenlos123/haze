...
import { compareItemsByFuzzyScore, FuzzyScore, FuzzyScore2, FuzzyScorerCache, IItemAccessor, IItemScore, pieceToQuery, prepareQuery, scoreFuzzy, scoreFuzzy2, scoreItemFuzzy } from './oracle.ts';
import { Schemas, basename, dirname, posix, sep, win32, isWindows, URI } from './shims.ts';
...
describe('Fuzzy Scorer', () => {
	...
	it('compareFilesByScore - skip preference on label match when using path sep', function () {
	...
	it('compareFilesByScore - boost consecutive matches in the beginning over end', function () {
	...
	it('Workspace symbol search with special characters (#, *)', function () {
